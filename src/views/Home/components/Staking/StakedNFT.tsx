import StakeMark from "../../../../assets/img/stake-mark-expand.png";

function StakedNFT(props: any) {
                  ...
                  <div className="defi-box-left">
                    <div className="defi-box-img">
                      <img
                        ...
                        className="defi-img-4 pos"
                      ></img>
                      <img src={StakeMark} className="defi-img-4"></img>
                    </div>
                  </div>
                </div>
                ...
                <div className="defi-mark-row">
                  <div className="defi-mark">
                    <span className="defi-mark-id text-bold">
                      {props.nftData.normalReward} $TWT / DAY
                    </span>
                  </div>
                  <input
